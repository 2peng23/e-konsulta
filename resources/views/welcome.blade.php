            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-news">
                        <div class="news-head">
                            <img src="user/img/blog1.jpg" alt="#">
                        </div>
                        <div class="news-body">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-news">
                        <div class="news-head">
                            <img src="user/img/blog2.jpg" alt="#">
                        </div>
                        <div class="news-body">
                            <div class="news-content">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-news">
                        <div class="news-head">
                            <img src="user/img/blog3.jpg" alt="#">
                        </div>
                        <div class="news-body">
                            <div class="news-content">
                ...
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="owl-carousel clients-slider">
                        <div class="single-clients">
                            <img src="user/img/client1.png" alt="#">
                        </div>
                        <div class="single-clients">
                            <img src="user/img/client2.png" alt="#">
                        </div>
                        <div class="single-clients">
                            <img src="user/img/client3.png" alt="#">
                        </div>
                        <div class="single-clients">
                            <img src="user/img/client4.png" alt="#">
                        </div>
                        <div class="single-clients">
                            <img src="user/img/client5.png" alt="#">
                        </div>
                        <div class="single-clients">
                            <img src="user/img/client1.png" alt="#">
                        </div>
